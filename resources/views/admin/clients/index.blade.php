...
<div class="card border-0 mb-4 d-none d-lg-block">
    ...
    <div class="card-header bg-white border-0 py-3 ps-2 pe-0 d-flex justify-content-between align-items-center">
        <div class="small text-muted">{{ $clients->count() }} clients</div>
        <input type="text" class="form-control form-control-sm" placeholder="Search client..." style="max-width: 220px;">
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover align-middle mb-0">
                ...
                @forelse ($clients as $client)
                    <tr>
                        <td class="py-3 ps-3 fw-medium text-dark">{{ $client->name }}</td>
                        <td class="py-3 ps-3 text-muted small">{{ $client->email }}</td>
                        <td class="py-3 ps-3">
